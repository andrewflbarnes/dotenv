...
# General {
	...
	# The theme to use.
	export TMUX_POWERLINE_THEME="barnes"
...
# macos_notification_count.sh {
	...
	# sqlite3 -list "/var/folders/mq/vhy6dqn57lv57_fcsp8fs4k00000gn/0//com.apple.notificationcenter/db/db" 'select * from app_info'
...
# time.sh {
	...
	export TMUX_POWERLINE_SEG_TIME_TZ="Europe/London"
# }
